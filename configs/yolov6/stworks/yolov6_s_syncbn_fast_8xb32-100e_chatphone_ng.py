...
# dataset settings
data_root = 'data/chat_phone/'
dataset_type = 'YOLOv5ChatPhoneNGDataset'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=f'{data_root}/new_version',
        img_subdir=f'{data_root}/new_version/JPEGImages',
        ann_subdir=f'{data_root}/new_version/Annotations',
        ann_file='train.txt',
