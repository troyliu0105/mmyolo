...
# dataset settings
data_root = 'data/auto_roi/'
dataset_type = 'YOLOv5AutoROISDataset'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=f'{data_root}/resample',
        img_subdir=f'{data_root}/resample/JPEGImages',
        ann_subdir=f'{data_root}/resample/Annotations',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=f'{data_root}/1026_test',
        img_subdir=f'{data_root}/1026_test/JPEGImages',
        ann_subdir=f'{data_root}/1026_test/Annotations',
        ann_file='trainval.txt',
